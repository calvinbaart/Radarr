    ...
    public class NewznabRequestGenerator : IIndexerRequestGenerator
    {
        ...
        public IndexerPageableRequestChain GetSearchRequests(MovieSearchCriteria searchCriteria)
        {
            ...
            else
            {
                ...
                var altTitles = searchCriteria.Movie.AlternativeTitles.Take(5).Select(t => System.Web.HttpUtility.UrlPathEncode(Parser.Parser.ReplaceGermanUmlauts(Parser.Parser.NormalizeTitle(t.Title)))).ToList();
